...
$gameinfos = [
	...
	'tie_breaker_description' => "In the case of a tie the tied player who has the most villages on the map is the winner. If there is still a tie then the player who has gained the most Victory Points from capturing. Any tied situation after that remains tied.",
